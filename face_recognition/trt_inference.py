...
def requestGenerator(batched_image_data, input_name, output_name, dtype, classes, model_name, model_version):
    client = httpclient
...
def trt_infer(batch_dict, blob, model_name, model_version=''):
    ...
    for inputs, outputs, model_name, model_version in requestGenerator(
            batched_image_data, input_name, output_name, dtype, classes, model_name, model_version):
        sent_count += 1
